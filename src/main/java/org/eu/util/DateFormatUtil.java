...
public class DateFormatUtil {
	 ...
	 */
	private static final SimpleDateFormat formatCodeP = new SimpleDateFormat("yyyyMMddHHmmss");
...
//		 return new Timestamp(new Date().getTime());
	...
	/**
	 * Date类型数据转换为字符串yyyyMMddHHmmssSSS
	 *
	 * @param date Date类型数据
	 * @return yyyyMMddHHmmssSSS的字符串
	 */
	public static String formatCodeP(Date date) {
		return formatCodeP.format(date);
	}

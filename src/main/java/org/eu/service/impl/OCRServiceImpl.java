...
public class OCRServiceImpl implements OCRService {
    ...
    @Override
    public Map<String,Object> detectPic(MultipartFile multipartFile) throws IOException {
...
//        String path = "https://aip.baidubce.com/rest/2.0/ocr/v1/general_basic?access_token="+accessToken;
    ...
    public Map<String,Object> analysisData(String ocrData){
        Map<String,Object> resultMap = new HashMap<>();
        ...
        if(analysisMode=="single"){
            resultMap.putAll(analysisSingleData(wordList));
        }else if(analysisMode=="multiple"){
            resultMap = analysisMultipleData(wordList);
        }
    ...
    public Map<String,String> analysisSingleData(List<String> wordList){
...
//                }
            ...
            if(wordList.get(i).indexOf("最后一击") != -1 )
            {
                ...
                {
                    if((wordList.get(i).indexOf("号") != -1||wordList.get(i).indexOf("级") != -1) && wordList.get(j).indexOf("旗舰") == -1)
                    {
...
//        resultMap.put("reportId",reportId);
    ...
    public Map<String,Object> analysisMultipleData(List<String> wordList){
        Map<String,Object> resultMap = new HashMap<>();
        List<String> armyShortNameList = armyMapper.listArmyShorName();
